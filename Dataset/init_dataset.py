...
if __name__=='__main__':
    ...
    # dataset_name = 'cifar_10/CIFAR-10_styled_train'
    # dataset_root = r'./'+dataset_name
    # Cifar10styled = CIFAR_C(path=dataset_root,c_type='random_noise', corrupt_rate=1)
    # print(len(Cifar10styled))
    # data = Cifar10styled.images
    # label = Cifar10styled.labels
    # # data = Cifar10FLTest.data
    # # label = Cifar10FLTest.target
    # for j in range(50000):
    #     imgdata = data[j, :, :, :]
